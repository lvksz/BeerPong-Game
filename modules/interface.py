...
from modules.db import stworz_baze_danych, dodaj_gracza, pobierz_gracza, zaktualizuj_gracza, pobierz_wszystkich_graczy
...
def run_interface():
    ...
    global entry_nowy_gracz, var_domowy_wygrany, tree_statystyki
    stworz_baze_danych()
